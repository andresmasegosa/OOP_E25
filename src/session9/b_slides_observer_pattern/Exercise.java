...
/*
    ...
    **Task:** Modify the `BankAccount` class to use the Observer Pattern for monitoring deposits.

    **Description:**
    1. Implement an observer `SkatMonitor` that:
        - Prints an alert message if a deposit exceeds 1 million kroner.
    4. Test the implementation:
        - Create a `BankAccount` instance and attach a `SkatMonitor` and BankStatistics are listeners.
        - Deposit amounts and observe the behavior when deposits exceed 1 million kroner.
*/
