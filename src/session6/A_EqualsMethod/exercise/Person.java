...
public class Person {
    ...
    public boolean equals(Object o) {
        ...
        return age == person.age &&  firstName.toLowerCase().compareTo(person.firstName.toLowerCase())==0 && Objects.equals(lastName, person.lastName);
    }
    ...
    public static void main(String[] args) {
        ...
        Person person2 = new Person("Anders", "M", "Madsen", 48);
        ...
        feedback.Feedback.submit("session5_A", I_did_finish, I_did_understand, comment);
        */
    }
